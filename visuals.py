...
def evaluate(results, accuracy, f1):
    ...
    # Constants
    bar_width = 0.1
    colors = ['#A00000','#00A0A0','#00A000','#b22a65','#306fc1','#c0ea38', '#ef911f','#622a93','#b290d1','#ea383e']
    ...
    ax[2, 0].set_title("F-score on Training Subset")
    ...
    ax[2, 0].axhline(y = f1, xmin = -0.1, xmax = 3.0, linewidth = 1, color = 'k', linestyle = 'dashed')
    ax[2, 1].axhline(y = f1, xmin = -0.1, xmax = 3.0, linewidth = 1, color = 'k', linestyle = 'dashed')
    ...
    plt.legend(handles = patches, bbox_to_anchor = (0.5, -0.2), \
               loc = 'upper center', borderaxespad = 0., ncol = 2, fontsize = 'x-large')

    # Aesthetics
    plt.suptitle("Performance Metrics for Ten Supervised Learning Models", fontsize = 16, y = 1.05)
    plt.tight_layout()
    plt.show()
